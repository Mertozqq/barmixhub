      ...
      <section className="hero-section">
        <div className="container hero-grid">
          ...
          <Reveal className="hero-copy" delay={0.15}>
            ...
            <p>
              BarMix собирает живой формат для новичков и тех, кто только начинает знакомство с барной
            ...
            <div className="hero-schedule">
              <div>
                ...
                <p>Один шестинедельный интенсив с очными встречами и демонстрациями</p>
              </div>
              <div>
